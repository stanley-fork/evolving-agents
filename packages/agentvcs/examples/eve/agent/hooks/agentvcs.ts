/**
 * agentvcs trace bridge for Vercel eve.
 *
 ...
 *
 *   Drop this file at:  agent/hooks/agentvcs.ts
 *   It writes to:       <project>/.eve/agentvcs/trace.jsonl   (one event / line)
 *   Then:               agentvcs init --eve && agentvcs commit -m "..."
 *
