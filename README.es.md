...
<a href="https://evolvingagentslabs.github.io/demo/"><img src="doc/assets/manual/09-desk.jpg" alt="El escritorio: cada caja es un agente, las líneas entre ellas son los traspasos, y un solo panel inspecciona lo que esté seleccionado" width="100%"></a>

<sub><b><a href="https://evolvingagentslabs.github.io/demo/">Probá el escritorio →</a></b> Cada caja es un agente. Las líneas entre ellas son los traspasos, y el punto que viaja por una línea es lo que efectivamente se movió. Un solo panel inspecciona lo que selecciones — o arrastrás <code>INSPECTOR</code> encima y dejás que lo lea un agente, y <b>cada frase que produce lleva la dirección de lo que leyó</b>. Cuando no tiene nada que leer dice <i>unknown</i>, y el escritorio lo dibuja distinto de una respuesta.<br><br>Abre en <b>coclea-sr</b>: dos cadenas, los mismos seis agentes, las dos en verde, una equivocada en todos sus números — separadas únicamente por una compuerta declarada antes de correr. El segundo scope es <b>hemo-verified</b>, donde no hay forma cerrada, así que lo que se mide es el juez mismo. <b>La orquestación es simulada</b> — sin core, sin modelo, nada guardado — pero los números que muestran esos dos scopes salen de los artefactos de los propios proyectos, y <a href="scripts/check-demo-provenance.py"><code>check-demo-provenance.py</code></a> rompe el build si alguno deja de coincidir. Para re-derivarlos vos mismo, byte por byte, en tu navegador: <b><a href="https://evolvingagentslabs.github.io/verify/">la página de verificación</a></b>. Esa página no es un demo y no pretende serlo.</sub>
