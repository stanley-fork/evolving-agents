...
<a href="https://evolvingagentslabs.github.io/demo/"><img src="doc/assets/manual/09-desk.jpg" alt="Un haz de flows enroscado alrededor de un eje de tiempo, con los agentes cabalgando las hebras que sostienen" width="100%"></a>

<sub><b><a href="https://evolvingagentslabs.github.io/demo/">Abrí el demo →</a></b> <b>Un eje, y es el tiempo.</b> Cada flow es una hebra enroscada a su alrededor, así que comparten la misma banda de pantalla y se separan <b>en profundidad</b>, no en altura — lo brillante y grueso está adelante, lo tenue está detrás del haz. <b>Arrastrá para girarlo.</b> Girar es cómo prestás atención: otra hebra viene al frente sin que nada tenga que correrse.<br><br><b>Los agentes cabalgan la hebra que sostienen.</b> Un círculo es un agente con el pensamiento en la mano; donde hay una marca hueca, nadie lo está sosteniendo — eso es lo que va en tránsito entre dos. <code>INSPECTOR</code>, un agente de sistema con una sola herramienta (read), se engancha a cualquier hebra y la cabalga, y todo lo que dice lleva la dirección de lo que leyó.<br><br><b>Dos movimientos, dos significados.</b> Todo se desplaza a la izquierda siempre, porque el reloj corre — lo cual es incondicionalmente cierto, y como las hebras se retuercen a lo largo del eje ese desplazamiento también gira el haz. La luz viaja una hebra <i>sólo</i> donde hay un paso abierto ahora. Y <b>girar es una afirmación</b>: el panel dice qué hebra está adelante, por qué, y de dónde lo leyó — un giro que la superficie no puede justificar es uno que se niega a hacer.<br><br>Alejarse agrega en vez de encoger: por debajo de cuarenta y seis píxeles por vuelta el espiral deja de dibujarse y lo dice, porque lo que verías sería el muestreo y no la forma. Cuatro scopes, todos reales — <b>coclea-sr</b> (una compuerta que midió 2.592e-4 contra una tolerancia de 1.0e-4), <b>hemo-verified</b> (sin forma cerrada, así que se mide al juez: 0.9056), y dos que cargan un flow verde y equivocado. <b>La orquestación es simulada</b>; los números salen de los artefactos de los proyectos, y <a href="scripts/check-demo-provenance.py"><code>check-demo-provenance.py</code></a> rompe el build si alguno deja de coincidir. Para re-derivarlos vos: <b><a href="https://evolvingagentslabs.github.io/verify/">la página de verificación</a></b>.</sub>
