...
<a href="https://evolvingagentslabs.github.io/demo/"><img src="doc/assets/manual/09-desk.jpg" alt="Hilos de pensamiento: lo horizontal es tiempo, cada cuerda es un flow, y dónde está es qué agente lo sostiene" width="100%"></a>

<sub><b><a href="https://evolvingagentslabs.github.io/demo/">Abrí el demo →</a></b> <b>Lo horizontal es tiempo y el borde derecho es ahora.</b> Cada cuerda es un flow; dónde está dice qué agente lo sostiene. Arranca con vos preguntando, baja por los agentes y — si terminó — vuelve a vos. Arrastrá a la izquierda para ir atrás, scroll para zoom, clickeá cualquier cuerda o cuenta.<br><br><b>El tono es qué hilo. La textura es qué pasó.</b> Un salto que llevó algo está encendido; uno que llegó y nadie usó se apaga; uno esperando veredicto se deshilacha; y uno que nadie registró <b>no se dibuja</b> — ves el fondo a través, porque <i>no corrió</i> no es <i>pasó</i>.<br><br><b>Y todo lo que se mueve es una medición.</b> Se anima exactamente una cosa sola: un paso abierto ahora mismo. Cuando no hay ninguno, nada en la página se mueve — que es lo único que hace creíble la versión que sí se mueve.<br><br>Cuatro scopes, todos reales: <b>coclea-sr</b> (dos cadenas, los mismos seis agentes, con treinta horas de diferencia — una volvió, la otra frenó en una compuerta que midió 2.592e-4 contra una tolerancia de 1.0e-4), <b>hemo-verified</b> (sin forma cerrada, así que se mide al juez: 0.9056 contra un umbral escrito antes), y los dos scopes que cargan un flow verde y equivocado. <b>La orquestación es simulada</b> — sin core, sin modelo, nada guardado — pero los números salen de los artefactos de los proyectos, y <a href="scripts/check-demo-provenance.py"><code>check-demo-provenance.py</code></a> rompe el build si alguno deja de coincidir. Para re-derivarlos vos, byte por byte, en tu navegador: <b><a href="https://evolvingagentslabs.github.io/verify/">la página de verificación</a></b>.</sub>
